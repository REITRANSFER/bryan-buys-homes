...
export async function POST(request: Request) {
  try {
    ...
    // client IP) so the CRM/tracker ip fields and the Meta CAPI client_ip populate.
    ...
    try {
      const GF_CREDENTIAL_ID = process.env.GOFUNNEL_WEBHOOK_CREDENTIAL_ID || "0389753d-891f-4b63-b85a-5ee7303e99f0"
      const GF_BEARER = process.env.GOFUNNEL_WEBHOOK_SECRET || "ea39d5c6-80cd-465c-9275-cac2b05094de"
      if (GF_CREDENTIAL_ID && GF_BEARER) {
        ...
        const gfPayload = {
          ...
          sid: gfSid || undefined,
          formId: "bryan-buys-homes-survey",
          formTitle: "(Lori and Cam) Bryan Buys Homes Survey",
